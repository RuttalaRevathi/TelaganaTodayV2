        ...
        <View style={{flex: 1, backgroundColor: whitecolor}}>
          ...
          <ScrollView style={{paddingBottom: 50}}>
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/india.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="India"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/world.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="World"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/cinema.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Entertainment"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/science.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Science & Tech"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/rewind.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Rewind"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/viewpoint.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Viewpoint"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/columns.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Columns"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/education.png')}
                  style={sideMenuStyle.icon}
                />
              )}
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/reviews.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Reviews"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/property.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Property"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/lifestyle.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="Lifestyle"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/epaper.png')}
                  style={sideMenuStyle.icon}
                />
              )}
              label="E-paper"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/facebook.png')}
                  style={{}}
                />
              )}
              label="Facebook"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/twitter.png')}
                  style={{}}
                />
              )}
              label="Twitter"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/youtube.png')}
                  style={{}}
                />
              )}
              label="Youtube"
            ...
            <DrawerItem
              ...
              icon={({color, size}) => (
                <Image
                  source={require('../Assets/Images/sidemenuIcons/telegram.png')}
                  style={{}}
                />
              )}
              label="Telegram"
