...
// Live version-1
export const BaseUrl = 'https://telanganatoday.com/wp-json/ttnews/v1/';
// Live version-2
...
export const ShareUrl = 'https://telanganatoday.com/';
...
export const Science = 'tech';
export const Sports = 'sport';
export const Business = 'business';
export const Rewind = 'rewind';
export const Nri = 'nri';
export const Viewpoint = 'opinion';
export const Cartoonurl = 'cartoon';
export const Columuns = 'columns';
export const Education = 'education-today';
